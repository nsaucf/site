...
/**
 * Static Instagram embed (neuroallianceucf) sized to match the previous slideshow.
 */
export function Slideshow() {
    ...
    return (
        <div className="relative h-[400px] w-full overflow-hidden rounded-2xl border border-white/10 bg-white shadow-2xl lg:h-[500px]">
            <div className="h-full w-full overflow-y-auto p-2">
                <blockquote
                    className="instagram-media"
                    data-instgrm-permalink="https://www.instagram.com/neuroallianceucf/?utm_source=ig_embed&amp;utm_campaign=loading"
                ...
                >
                    <div style={{ padding: 16 }}>
                        <a
                            href="https://www.instagram.com/neuroallianceucf/?utm_source=ig_embed&amp;utm_campaign=loading"
